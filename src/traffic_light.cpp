...
void TrafficLight::set_go_texture(const Ref<Texture2D> &texture) {
    go_texture = texture;
}

void TrafficLight::set_stop_texture(const Ref<Texture2D> &texture) {
    stop_texture = texture;
}

void TrafficLight::set_caution_texture(const Ref<Texture2D> &texture) {
    caution_texture = texture;
}
